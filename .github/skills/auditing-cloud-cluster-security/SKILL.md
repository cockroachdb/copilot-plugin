...
**Remediation (self-hosted):** [managing-tls-certificates](https://github.com/cockroachlabs/cockroachdb-skills/blob/main/skills/cockroachdb-security-and-governance/managing-tls-certificates/SKILL.md)
...
- [sample-report.md](references/sample-report.md)
